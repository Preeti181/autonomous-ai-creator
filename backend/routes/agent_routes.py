...
def create_topic():
    try:
        ...
        url = (
            "https://autonomous-ai-creator.local/topic/"
            f"{uuid.uuid4()}"
        )
        ...
        topic = Topic(
            ...
            status="scored",
            reason=(
                "Topic generated by the autonomous "
...
def generate_post():
    try:
        ...
        # If requested topic doesn't exist, use latest topic
        if not topic:
            topic = (
                Topic.query
        ...
        # If database has no topic at all, create one
        if not topic:
            topic = Topic(
                title="The Future of Autonomous AI Agents",
                source="Autonomous AI Creator",
                url=(
                    "https://autonomous-ai-creator.local/"
                    "topic/autonomous-ai"
                ),
                score=1.0,
                status="scored",
                reason=(
                    "Default topic created automatically "
                    "for autonomous post generation."
                )
            )
